...
class Bot(ZaloAPI):
    ...
    def send_reo_file(self, thread_id, mentioned_user_id, mentioned_name, filename, delay, username_for_replace):
        try:
...
def run_tool():
    ...
    try:
        ...
        delay = 10
    username_for_replace = input("Nhập tên người muốn réo (dùng để thay {user}): ").strip()
